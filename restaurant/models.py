...
class FoodCategory(TimeStampedModel):
    ...
    name_en = models.CharField(verbose_name='Название на английском', max_length=255, blank=True, null=True, unique=True)
    name_ch = models.CharField(verbose_name='Название на китайском', max_length=255, blank=True, null=True, unique=True)
...
class Food(TimeStampedModel):
    ...
    additional = models.ManyToManyField('self', symmetrical=False, related_name='additionals', blank=True)
